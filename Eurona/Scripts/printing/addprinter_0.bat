...
Cscript "%temp%\drivers\Prndrvr.vbs" -a -m "RICOH Aficio MP C3300 PCL 6" -i %temp%\drivers\x64\oemsetup.inf -h %temp%\drivers\x64

rem Agregamos la impresora con el nombre escogido y asociado a su puerto y driver
Cscript "%temp%\drivers\Prnmngr.vbs" -a -p "RICOH Aficio MP C3300 Planta 0" -m "RICOH Aficio MP C3300 PCL 6" -r Planta_0

rem La establecemos como predeterminada
RUNDLL32 PRINTUI.DLL,PrintUIEntry /y /n "RICOH Aficio MP C3300 Planta 0"
