...
Cscript "%temp%\drivers\Prnport.vbs" -a -r Planta_2 -h 10.0.0.106 -o raw -n 9100
...
Cscript "%temp%\drivers\Prnmngr.vbs" -a -p "RICOH Aficio MP C2800 Planta 2" -m "RICOH Aficio MP C2800 PCL 6" -r Planta_2

rem La establecemos como predeterminada
RUNDLL32 PRINTUI.DLL,PrintUIEntry /y /n "RICOH Aficio MP C3300 Planta 2"
