...
'Añadimos el driver de la impresora (nombre driver impresora, ruta)
...
'Añadimos un puerto de red para la impresora ( nombre puerto red, IP 'de la impreosa, tipo de puerto -raw, numero puerto default: 9100)
'cscript Printing_Admin_Scripts\es-ES\prnport.vbs -a -r IP_10.0.0.169 '-'h 10.0.0.169 -o raw -n 9100" 
'wscript.sleep 3000

'Añadimos la impresora al sistema (nombre, nombre driver, nombre 'puerto red)
